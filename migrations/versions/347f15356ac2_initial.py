...
def upgrade() -> None:
    ...
    sa.Column('player_count', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
    sa.Column('game_type', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
    sa.Column('playtime', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
    sa.Column('complexity', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
